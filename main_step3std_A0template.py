...
from Engine.classes_A0template import fitobjs,inparams
from Engine.macbro import macbro
from Engine.rebin_jv import rebin_jv
from Engine.rotint import rotint
from Engine.opt_A0template import optimizer, fmod
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
        ...
        uatm_in = uatm[(watm > min(wave_piece)*1e4 - 11) & (watm < max(wave_piece)*1e4 + 11)]
        ...
        fitobj = fitobjs(s_piece, x_piece, u_piece, watm_in, satm_in, uatm_in, mflux_in,mwave_in)
#-------------------------------------------------------------------------------
        ######## Begin optimization  ########
