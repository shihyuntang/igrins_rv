...
#-------------------------------------------------------------------------------
    ...
    for t in np.arange(len(tagsnight)):
        ...
        #
        # A0loc = f'./Output/{args.targname}_{args.band}/A0Fits_singlebucket/{night[:8]}A0_{beam}treated_{args.band}_singlebucket.fits'
        ...
        A0loc = f'./Output/{args.targname}_{args.band}/A0Fits_singlebucket/{night[:8]}A0_{antibeam}treated_{args.band}_singlebucket.fits'
