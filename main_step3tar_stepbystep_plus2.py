...
#            outplotter(targname,par_in,fitobj,'{}_{}_{}_1'.format(label,night,tag))
        ...
        parfit_5 = optimizer(parfit_4,dpar_s,hardbounds,fitobj,optimize)

        parfit_6 = optimizer(parfit_5,dpar_cont,hardbounds,fitobj,optimize)
        parfit_7 = optimizer(parfit_6,dpar_wave,hardbounds,fitobj,optimize)
        parfit_8 = optimizer(parfit_7,dpar_t,hardbounds,fitobj,optimize)
        parfit_9 = optimizer(parfit_8,dpar_ip,hardbounds,fitobj,optimize)
        parfit_10 = optimizer(parfit_9,dpar_s,hardbounds,fitobj,optimize)

        parfit_11 = optimizer(parfit_10,dpar_cont,hardbounds,fitobj,optimize)
        parfit_12 = optimizer(parfit_11,dpar_wave,hardbounds,fitobj,optimize)
        parfit_13 = optimizer(parfit_12,dpar_t,hardbounds,fitobj,optimize)
        parfit_14 = optimizer(parfit_13,dpar_ip,hardbounds,fitobj,optimize)
        parfit_15 = optimizer(parfit_14,dpar_s,hardbounds,fitobj,optimize)

        parfit_16 = optimizer(parfit_15,dpar_cont,hardbounds,fitobj,optimize)
        parfit_17 = optimizer(parfit_16,dpar_wave,hardbounds,fitobj,optimize)
        parfit_18 = optimizer(parfit_17,dpar_t,hardbounds,fitobj,optimize)
        parfit_19 = optimizer(parfit_18,dpar_ip,hardbounds,fitobj,optimize)
        parfit_20 = optimizer(parfit_19,dpar_s,hardbounds,fitobj,optimize)

        parfit_21 = optimizer(parfit_20,dpar_cont,hardbounds,fitobj,optimize)
        parfit_22 = optimizer(parfit_21,dpar_wave,hardbounds,fitobj,optimize)
        parfit_23 = optimizer(parfit_22,dpar_t,hardbounds,fitobj,optimize)
        parfit_24 = optimizer(parfit_23,dpar_ip,hardbounds,fitobj,optimize)
        parfit = optimizer(parfit_24,dpar_s,hardbounds,fitobj,optimize)
