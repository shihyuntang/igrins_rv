...
# old H tight~ 0.0149323 , 0.02518648, 0.00716132, 0.00592511, 0.04312596, 0.0075384
        #                                                6           14          16         21          22
        self.methodvariance_tight = { 'H': np.array([0.00855153, 0.00844732, 0.00473907, 0.16582762, 0.0107556]),
        #                                                 3          4           5           6
                                      'K': np.array([0.00416076, 0.00169457, 0.00262043, 0.00064745])
                                    }
        self.methodvariance_loose = { 'H': np.array([0.00855153, 0.00844732, 0.00473907, 0.16582762, 0.0107556]),
                                      'K': np.array([0.02533222, 0.02016001, 0.00239076, 0.00077493])
                                    }
