...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict):
        ...
        self.ips_tightmount_pars = { 'H':{
                                            2: np.array([-0.00, +0.00, 3.6]),
                                            3: np.array([-0.00, +0.00, 3.5]),
                                            4: np.array([-0.00, +0.00, 3.2]),
                                            5: np.array([-0.00, +0.00, 3.8]),
                                            6: np.array([-0.00, +0.00, 3.8]),
                                            10: np.array([-0.00, -0.00, 4.3]),
                                            11: np.array([-0.00, -0.00, 3.7]),
                                            13: np.array([-0.00, -0.00, 3.6]),
                                            14: np.array([-0.00, -0.00, 3.9]),
                                            16: np.array([-0.00, -0.00, 3.7]),
                                            17: np.array([-0.00, -0.00, 2.7]),
                                            20: np.array([+0.00, -0.00, 3.0]),
                                            21: np.array([+0.00, -0.00, 3.4]),
                                            22: np.array([+0.00, -0.00, 3.2])},
                                    'K':{   2: np.array([-0.00, +0.00, 2.5]),
                                            3: np.array([-0.00, -0.00, 3.5]),
                                            4: np.array([-0.00, -0.00, 3.7]),
                                            5: np.array([-0.00, -0.00, 3.1]),
                                            6: np.array([+0.00, -0.00, 3.5]),
                                            7: np.array([+0.00, -0.00, 3.4]),
                                            8: np.array([+0.00, -0.00, 3.0]),
                                            10: np.array([-0.00, +0.00, 2.1]),
                                            11: np.array([+0.00, -0.00, 3.1]),
                                            12: np.array([+0.00, -0.00, 2.3]),
                                            13: np.array([+0.00, -0.00, 1.9]),
                                            14: np.array([+0.00, -0.00, 2.8]),
                                            16: np.array([-0.00, +0.00, 1.7])}
                                    }
        self.ips_loosemount_pars = { 'H':{
                                            2: np.array([-0.00, +0.00, 3.6]),
                                            3: np.array([-0.00, +0.00, 3.8]),
                                            4: np.array([-0.00, +0.00, 3.5]),
                                            5: np.array([-0.00, -0.00, 4.2]),
                                            6: np.array([-0.00, +0.00, 3.7]),
                                            10: np.array([-0.00, -0.00, 4.3]),
                                            11: np.array([-0.00, -0.00, 4.0]),
                                            13: np.array([-0.00, +0.00, 3.8]),
                                            14: np.array([-0.00, -0.00, 4.3]),
                                            16: np.array([-0.00, -0.00, 3.9]),
                                            17: np.array([-0.00, -0.00, 3.4]),
                                            20: np.array([+0.00, -0.00, 3.3]),
                                            21: np.array([+0.00, -0.00, 3.4]),
                                            22: np.array([-0.00, -0.00, 3.4])},
                                    'K':{   2: np.array([-0.00, +0.00, 3.9]),
                                            3: np.array([-0.00, +0.00, 4.2]),
                                            4: np.array([-0.00, +0.00, 4.0]),
                                            5: np.array([-0.00, -0.00, 4.2]),
                                            6: np.array([-0.00, +0.00, 4.2]),
                                            7: np.array([-0.00, -0.00, 4.3]),
                                            8: np.array([-0.00, -0.00, 4.3]),
                                            10: np.array([-0.00, -0.00, 4.3]),
                                            11: np.array([+0.00, -0.00, 3.9]),
                                            12: np.array([+0.00, -0.00, 3.3]),
                                            13: np.array([-0.00, -0.00, 3.0]),
                                            14: np.array([+0.00, -0.00, 4.1]),
                                            16: np.array([-0.00, -0.00, 2.7])}
                                    }
        #
