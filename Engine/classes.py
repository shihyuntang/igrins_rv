...
ips_tight = { 'H':{
                ...
                'K':{
                    'A':{
                        ...
                        4: np.array([+0.0000009896, -0.0022434834, +3.3639406686]), #NEW
                        5: np.array([+0.0000009283, -0.0020437311, +3.3111026845]), #NEW
                        6: np.array([+0.0000002422, -0.0007174575, +2.8053671209]), #NEW
...
class fitobjs:
    ...
    def __init__(self,s, x, u,continuum,watm_in,satm_in,mflux_in,mwave_in,mask,masterbeam,CRmask,initwave,molmask):
        self.s = s
        self.x = x
        self.u = u
...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict,maskdict):
        ...
        #                                                6           14          16         21          22
        self.methodvariance_tight = { 'H': np.array([0.0115497, 0.00834182, 0.00496473, 0.16538301, 0.00582415]),
        #                                                 3          4           5           6
                                      'K': np.array([0.00287737, 0.00181387, 0.00265225, 0.00095388])
                                    }
        self.methodvariance_loose = { 'H': np.array([0.0115497, 0.00834182, 0.00496473, 0.16538301, 0.00582415]),
                                      'K': np.array([0.01852495, 0.02238276, 0.00445595, 0.00082747])
                                    }
