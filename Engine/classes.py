...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict,maskdict):
        ...
        #                                                6           13          14          16         21          22
        self.methodvariance_tight = { 'H': np.array([0.01138878, 0.01874542, 0.00423457, 0.00414062, 0.04098567, 0.00811581]),
        #                                                 3          4           5           6
                                      'K': np.array([0.00623669, 0.00203762, 0.00571498, 0.00114858])
                                    }
        self.methodvariance_loose = { 'H': np.array([np.nan    , np.nan    , np.nan    , np.nan    ]),
                                      'K': np.array([0.02218953, 0.01102905, 0.01312213, 0.00059992])
                                    }
