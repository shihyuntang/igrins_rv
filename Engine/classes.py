...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict,maskdict):
        ...
        self.ips_tightmount_pars = { 'H':{
                                             5: np.array([-0.00000008, -0.00032602, 3.6576819]),
                                             6: np.array([-0.00000063, +0.00068522, 3.6129724]),
                                             13: np.array([-0.00000036, -0.00041668, 3.5941849]),
                                             14: np.array([-0.00000008, -0.00025328, 3.6195833]),
                                             16: np.array([-0.00000001, -0.00040003, 3.5578423]),
                                             21: np.array([+0.00000001, -0.00060662, 3.3632623]),
                                             22: np.array([-0.00000007, -0.00028696, 3.2268485]) },
        ...
        #                                               14-1        16-1        21-1       22-1
        self.methodvariance_tight = { 'H': np.array([0.00611774, 0.00493196, 0.03789919, 0.00677369]),
        #                                               3-1         3-2         4-1         5-1         5-2         6-1         6-2
                                      'K': np.array([0.00372752, 0.00954158, 0.00208421, 0.01131535, 0.00353488, 0.00174423, 0.00491048])
                                    }
        self.methodvariance_loose = { 'H': np.array([np.nan    , np.nan    , np.nan    , np.nan    ]),
                                      'K': np.array([0.01905146, 0.01103015, 0.02253331, 0.01271237, 0.00984838, 0.00171933, 0.00295499])
                                    }
