        ...
        self.ips_tightmount_pars = { 'H':{
                                    ...
                                    'K':{
                                        'A':{
                                            ...
                                            2: np.array([+0.0000019594, -0.0042332806, +3.3065767470]),
                                            7: np.array([+0.0000003509, -0.0007603099, +2.6887055560]),
                                            8: np.array([+0.0000006210, -0.0012338115, +2.7943050535]),
                                            10: np.array([-0.0000001441, +0.0007404328, +1.2883109168]),
                                            14: np.array([+0.0000009873, -0.0023828741, +3.2582979944]),
                                            16: np.array([+0.0000001634, +0.0009254974, +1.1659480050]) },
                                        'B':{
                                            ...
                                            2: np.array([+0.0000019393, -0.0044004553, +3.5014833119]),
                                            7: np.array([+0.0000005784, -0.0016735449, +3.4502567594]),
                                            8: np.array([+0.0000007896, -0.0020320863, +3.4920380191]),
                                            10: np.array([-0.0000001725, +0.0003349626, +1.8108295453]),
                                            14: np.array([+0.0000006825, -0.0023026619, +3.4764877434]),
                                            16: np.array([+0.0000001889, +0.0005211189, +1.4905726750]) }
                                        }
                                    }
        ...
        self.ips_loosemount_pars = { 'H':{
                                    ...
                                    'K':{
                                        'A':{
                                            ...
                                            2: np.array([+0.0000000670, -0.0020713460, +4.8461595712]),
                                            7: np.array([+0.0000008338, -0.0035373021, +5.9139667340]),
                                            8: np.array([+0.0000011464, -0.0039421131, +5.7464134090]),
                                            10: np.array([+0.0000003023, -0.0018832260, +4.2108109349]),
                                            14: np.array([+0.0000019402, -0.0046975311, +4.9734401858]),
                                            16: np.array([+0.0000003516, -0.0002870902, +2.2015725110]) },
                                        'B':{
                                            ...
                                            2: np.array([-0.0000002388, -0.0019340287, +5.8701874036]),
                                            7: np.array([+0.0000006814, -0.0036136054, +6.7428210968]),
                                            8: np.array([+0.0000010868, -0.0042618105, +6.6592945497]),
                                            10: np.array([+0.0000000632, -0.0017216722, +4.7562678163]),
                                            14: np.array([-0.0000009985, +0.0001602803, +3.9085167854]),
                                            16: np.array([+0.0000003409, -0.0005813329, +2.7936047834])}
                                        }
                                    }
