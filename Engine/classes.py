...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict):
        ...
        self.ips_tightmount_pars = { 'H':{
                                            ...
                                            3:  np.array([-0.00000043, -0.00006703, 3.9611977]),#58 nights
                                            4:  np.array([-0.00000149, +0.00209742, 3.3050546]),#58 nights
                                            5:  np.array([-0.00000002, -0.00065262, 4.1537647]),#58 nights
                                            6:  np.array([-0.00000033, -0.00045954, 4.5292477]),#58 nights
                                            10: np.array([-0.00000053, -0.00002030, 4.3495785]),#58 nights
                                            11: np.array([-0.00000000, -0.00045612, 3.6545044]),
                                            13: np.array([-0.00000055, -0.00040286, 3.7453446]),#58 nights
                                            14: np.array([-0.00000001, -0.00077643, 4.1544333]),#58 nights
                                            16: np.array([-0.00000000, -0.00066207, 3.8317327]),#58 nights
                                            17: np.array([-0.00000000, -0.00000074, 2.6779583]),
                                            20: np.array([+0.00000001, -0.00041767, 3.0446818]),
                                            21: np.array([+0.00000001, -0.00069227, 3.4273789]),#58 nights
                                            22: np.array([+0.00000000, -0.00036886, 3.2415346]) },
                                    'K':{   2:  np.array([-0.00000017, +0.00017431, 1.5640266]),#58 nights
                                            3:  np.array([-0.00000011, -0.00076633, 3.1990425]),#58 nights
                                            4:  np.array([+0.00000003, -0.00065885, 3.2740824]),#58 nights
                                            5:  np.array([+0.00000012, -0.00038759, 2.8232853]),#58 nights
                                            6:  np.array([+0.00000004, -0.00055378, 3.1703867]),#58 nights
                                            7:  np.array([+0.00000013, -0.00069198, 3.4463934]),
                                            8:  np.array([+0.00000018, -0.00038681, 2.7319204]),#58 nights
                                            10: np.array([-0.00000000, +0.00019707, 2.0080079]),#58 nights
                                            11: np.array([-0.00000000, -0.00009746, 2.4911003]),#58 nights
                                            12: np.array([+0.00000000, -0.00070081, 2.2782001]),
                                            13: np.array([+0.00000000, -0.00049637, 1.8553702]),
                                            14: np.array([+0.00000040, -0.00104277, 2.811092]),
                                            16: np.array([-0.00000000, +0.00063948, 1.7424173]) }
                                    }
        self.ips_loosemount_pars = { 'H':{
                                            2:  np.array([-0.00000098, +0.00179662, 3.6487848]),
                                            3:  np.array([-0.00000036, -0.00020942, 4.1957959]),#58 nights
                                            4:  np.array([-0.00000154, +0.00193849, 3.7546865]),#58 nights
                                            5:  np.array([-0.00000012, -0.00049285, 4.3031075]),#58 nights
                                            6:  np.array([-0.00000037, -0.00028047, 4.4301934]),#58 nights
                                            10: np.array([-0.00000062, +0.00021284, 4.3700600]),#58 nights
                                            11: np.array([-0.00000001, -0.00043510, 4.0044980]),
                                            13: np.array([-0.00000065, -0.00035395, 3.9436255]),#58 nights
                                            14: np.array([-0.00000026, -0.00038821, 4.3163189]),#58 nights
                                            16: np.array([-0.00000000, -0.00065065, 3.9963982]),#58 nights
                                            17: np.array([-0.00000000, -0.00054249, 3.4089812]),
                                            20: np.array([+0.00000000, -0.00050703, 3.3124597]),
                                            21: np.array([-0.00000000, -0.00063989, 3.5101107]),#58 nights
                                            22: np.array([-0.00000000, -0.00037943, 3.4248205]) },
                                    'K':{   2:  np.array([-0.00000025, -0.00107469, 4.6589134]),#58 nights
                                            3:  np.array([-0.00000085, +0.00011615, 4.6091301]),#58 nights
                                            4:  np.array([-0.00000030, -0.00080111, 4.9548457]),#58 nights
                                            5:  np.array([-0.00000060, -0.00004331, 4.5193109]),#58 nights
                                            6:  np.array([-0.00000120, +0.00088767, 4.3650473]),#58 nights
                                            7:  np.array([-0.00000027, -0.00040471, 4.2938356]),
                                            8:  np.array([-0.00000034, -0.00050245, 4.4072179]),#58 nights
                                            10: np.array([-0.00000038, -0.00072934, 4.2700446]),#58 nights
                                            11: np.array([-0.00000008, -0.00106350, 4.2554992]),#58 nights
