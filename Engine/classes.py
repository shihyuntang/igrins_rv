...
class inparams:
    ...
    def __init__(self,inpath,outpath,initvsini,vsinivary,plotfigs,initguesses,bvcs,tagsA,tagsB,nights,mwave,mflux,a0dict,xbounddict):
        ...
        #                                               3-1         3-2         4-1         5-1         5-2         6-1         6-2         8-1
                                      'K': np.array([0.00395144, 0.01192028, 0.00221705, 0.01121753, 0.00285282, 0.00291294, 0.00418156, 0.00713487])
                                    }
        self.methodvariance_loose = { 'H': np.array([1.09931290, 0.00681664, 0.07082691, 0.06844897, 0.12497428, 0.01290872, 0.21664333, 0.04491236, 0.03837088, 0.01899447]),
                                      'K': np.array([0.58535824, 0.01874785, 0.02397995, 0.02103134, 0.01527656, 0.00105214, 0.00113549, 0.01926258])
                                    }
        #
