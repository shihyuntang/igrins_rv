...
# old H tight~ 0.0149323 , 0.02518648, 0.00716132, 0.00592511, 0.04312596, 0.0075384
        #                                                6           14          16         21          22
        self.methodvariance_tight = { 'H': np.array([0.31037078, 0.00783879, 0.0041863, 0.11128023, 0.00489308]),
        #                                                 3          4           5           6
                                      'K': np.array([0.00733249, 0.00165706, 0.0026913, 0.00082072])
                                    }
        self.methodvariance_loose = { 'H': np.array([0.31037078, 0.00783879, 0.0041863, 0.11128023, 0.00489308]),
                                      'K': np.array([0.05516125, 0.01844586, 0.00390093, 0.00085621])
                                    }
