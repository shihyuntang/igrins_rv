...
def fmodel_chi(par,grad):
    ...
    # Stellar template already rotationally broadened
    wspot2 = wspot
    rspot2 = sspot
    ...
    nsmod = macbro_dyn(vel,satm,vhwhm)

    #Now rebin the stellar template onto the telluric wavelength scale
    sspot2 = rebin_jv(wspot2,rspot2,watm,False)

    #Mutliply stellar template by telluric to create total spectrum
    nsmod = sspot2*satm
